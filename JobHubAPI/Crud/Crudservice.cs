...
namespace JobHubAPI.Crud
{
    public class CrudService<T>
    {
        ...
        public virtual async Task<int> RecordCountAsync(IDbConnection db, DbTransaction tran, string conditions = "", object parameters = null)
        {
            return await db.RecordCountAsync<T>(conditions, parameters, tran, null);
        }
